...
class CreateRectangle(Scene):
    def construct(self):
        ...
        pixel_1 = Rectangle(width= 0.2, height=4/3)
        pixel_2 = Rectangle(width= 0.2, height=4/3)
        pixel_3 = Rectangle(width= 0.2, height=4/3)
        pixel_1.move_to([5.1, -4/3, 0])
        pixel_2.move_to([5.1, 0, 0])
        pixel_3.move_to([5.1, 4/3, 0])
        pixel_1.set_fill(BLUE, opacity=0.5)
        pixel_2.set_fill(BLUE, opacity=0.5)
        pixel_3.set_fill(BLUE, opacity=0.5)
        ...
        l = Group(l1, l2, l3)
        lb = Line(start = [-5,0,0], end = [5,0,0])
        lc = Line(start = [5,0,0], end = [-5,0,0])
        ld = Line(start = [-5,0,0], end = [3,0,0])
        le_1 = Line(start = [3,-4/3,0], end = [5,-4/3,0])
        lf_1 = Line(start = [5,-4/3,0], end = [3,-4/3,0])
        lg_1 = Line(start = [3,-4/3,0], end = [-5,-4/3,0])
        le_2= Line(start = [3,0,0], end = [5,0,0])
        lf_2 = Line(start = [5,0,0], end = [3,0,0])
        lg_2 = Line(start = [3,0,0], end = [-5,0,0])
        le_3 = Line(start = [3,4/3,0], end = [5,4/3,0])
        lf_3 = Line(start = [5,4/3,0], end = [3,4/3,0])
        lg_3 = Line(start = [3,4/3,0], end = [-5,4/3,0])
        ellipse_1 = Ellipse(width=0.5, height=0.8, color= WHITE)
        ellipse_1.set_fill(color=WHITE, opacity=1)
        ellipse_1.move_to([3.5, 4/3, 0])
        ellipse_2 = Ellipse(width=0.5, height=0.8, color= WHITE)
        ellipse_2.set_fill(color=WHITE, opacity=1)
        ellipse_2.move_to([4.5, 4/3, 0])
        ellipse_3 = Ellipse(width=0.5, height=0.8, color= WHITE)
        ellipse_3.set_fill(color=WHITE, opacity=1)
        ellipse_3.move_to([3.5, -4/3, 0])
        ellipse_4 = Ellipse(width=0.5, height=0.8, color= WHITE)
        ellipse_4.set_fill(color=WHITE, opacity=1)
        ellipse_4.move_to([4.5, -4/3, 0])
        ellipse_5 = Ellipse(width=0.5, height=0.8, color= WHITE)
        ellipse_5.set_fill(color=WHITE, opacity=1)
        ellipse_5.move_to([3.5, 0, 0])
        ellipse_6 = Ellipse(width=0.5, height=0.8, color= WHITE)
        ellipse_6.set_fill(color=WHITE, opacity=1)
        ellipse_6.move_to([4.5, 0, 0])
        ...
        self.play(FadeOut(l))
        # Golven
        self.play((Rotate(ellipse_1, angle= (1/6)*PI, about_point= [3.5, 4/3, 0])),
                  (Rotate(ellipse_2, angle= (1/6)*PI, about_point= [4.5, 4/3, 0])))

        self.play((Rotate(ellipse_6, angle= (1/2)*PI, about_point= [4.5, 0, 0])),
                  (Rotate(ellipse_5, angle= (1/2)*PI, about_point= [3.5, 0, 0])))

        self.play((Rotate(ellipse_3, angle= (3/8)*PI, about_point= [3.5, -4/3, 0])),
                  (Rotate(ellipse_4, angle= (3/8)*PI, about_point= [4.5, -4/3, 0])))
